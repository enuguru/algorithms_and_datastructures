...
// max. cities
        ...
        for (int i = 0; i < n; i++)
        {
            tour[i] = i;  // tour[0] = 0 tour[1] = 1 tour[2] = 2  tour[3] = 3
            System.out.println(tour[i] + "tournumber  ");
        }
        cost = tspdp(c, tour, 0, n);  // c in the input array, tour array holds the tour
        // print tour cost and tour   // 0 is the start and n is the total number of cities
