...
/*  this is a  beautiful concept, how many activities on person can do at a time, 
    considering he is the only person doing the work  */
...
void printMaxActivities(int s[], int f[], int n)
{
    ...
    for (j = 1; j < n; j++)
    {
      ...
      if (s[j] >= f[i])  /* this "if" condition is important, this is key, read this */
      {
          printf ("%d ", j);
          i = j;
      }
